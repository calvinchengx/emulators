...
| emulator | green claims | diff: vs real | ci: external | sdk: only | own tests only | independently evidenced |
|---|---:|---:|---:|---:|---:|---:|
| fabric | 124 | 0 | 117 | 0 | 7 | **117/124 (94%)** |
| entra | 56 | 3 | 50 | 0 | 3 | **53/56 (95%)** |
| keyvault | 49 | 0 | 38 | 9 | 2 | **47/49 (96%)** |
| apim | 35 | 0 | 27 | 3 | 5 | **30/35 (86%)** |
| arm | 29 | 0 | 19 | 9 | 1 | **28/29 (97%)** |
| databricks | 31 | 0 | 31 | 0 | 0 | **31/31 (100%)** |
...
of ARM. And **almost none of this is differential evidence against Azure**:
the `diff: vs real` column is zero everywhere but entra, whose token endpoint
carries recorded comparisons against a live tenant behind 3 of its green rows.
Everywhere else green means witnessed locally against real clients, which is a
strong claim and a different one.
